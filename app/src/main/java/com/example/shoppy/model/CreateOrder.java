...
import com.example.shoppy.ultils.AppInfo;
import com.example.shoppy.zalo.Helper.Helpers;
import com.example.shoppy.zalo.HttpProvider;
...
public class CreateOrder {
    private class CreateOrderData {
     ...
     public JSONObject createOrder(String amount) throws Exception {
        ...
        JSONObject data = HttpProvider.sendPost(AppInfo.URL_CREATE_ORDER, formBody);//chỉnh được formBody: miêu tả
        return data;
    }
}
